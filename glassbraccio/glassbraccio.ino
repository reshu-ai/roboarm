...
void loop() {
  ...
  */
   ...
   delay(1000);
   Braccio.ServoMovement(20,         0, 150, 180, 20,105,  17); //grip close
   delay(1000);
   Braccio.ServoMovement(20,         0, 145, 180, 20,105 ,  17); //M2 moves up by 30 deg
   delay(1000);
   Braccio.ServoMovement(20,         180, 145, 180, 20, 105,  17); // 180deg move
   delay(1000);
   Braccio.ServoMovement(20,         180, 145, 180, 20, 105,  10); //Grip again opens 
   delay(1000);
}
